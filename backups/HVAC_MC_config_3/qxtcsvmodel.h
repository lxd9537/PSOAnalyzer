...
public:
    ...
    void setSource(QIODevice *file, bool withHeader = false, QChar separator = ',', const char *codecName = "UNICODE");
    void setSource(const QString filename, bool withHeader = false, QChar separator = ',', const char *codecName = "UNICODE");

    void toCSV(QIODevice *file, bool withHeader = false, QChar separator = ',', const char *codecName = "UNICODE") const;
    void toCSV(const QString filename, bool withHeader = false, QChar separator = ',', const char *codecName = "UNICODE") const;
