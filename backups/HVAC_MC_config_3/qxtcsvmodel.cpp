...
void QxtCsvModel::setSource(const QString filename, bool withHeader, QChar separator, const char *codecName)
{
    QFile src(filename);
    setSource(&src, withHeader, separator, codecName);
}

void QxtCsvModel::setSource(QIODevice *file, bool withHeader, QChar separator, const char *codecName)
{
 ...
 */ 
void QxtCsvModel::toCSV(QIODevice* dest, bool withHeader, QChar separator, const char *codecName) const
{
    ...
    if(codecName) stream.setCodec(codecName);
...
void QxtCsvModel::toCSV(const QString filename, bool withHeader, QChar separator, const char *codecName) const
{
    QFile dest(filename);
    toCSV(&dest, withHeader, separator, codecName);
}
