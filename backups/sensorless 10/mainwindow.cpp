    ...
    m_xls(nullptr)
{
    ...
    connect(ui->actionReport_Option,&QAction::triggered,this,&MainWindow::on_ReportOption_clicked);
...
void MainWindow::on_Load_clicked()
{
    ...
    m_reportOption.client = configIniRead->value("report/client").toString();
    m_reportOption.project = configIniRead->value("report/project").toString();
    m_reportOption.report_number =configIniRead->value("report/reportNo").toString();
    m_reportOption.cost_per_kWh = configIniRead->value("report/costPerKWh").toDouble();
    m_reportOption.days_per_year = configIniRead->value("report/daysPerYear").toDouble();

    ui->comboBox_loadprofile_app->setCurrentText(configIniRead->value("report/loadProfile").toString());
...
void MainWindow::on_SaveAs_clicked()
{
    ...
    configIniWrite->setValue("report/client", m_reportOption.client);
    configIniWrite->setValue("report/project", m_reportOption.project);
    configIniWrite->setValue("report/reportNo", m_reportOption.report_number);
    configIniWrite->setValue("report/costPerKWh", QString::number(m_reportOption.cost_per_kWh));
    configIniWrite->setValue("report/daysPerYear", QString::number(m_reportOption.days_per_year));

    configIniWrite->setValue("report/loadProfile", ui->comboBox_loadprofile_app->currentText());
...
void MainWindow::on_ReportOption_clicked()
{
    Dialog_ReportOption *dlg;
    dlg = new Dialog_ReportOption;
    dlg->setReportOption(&m_reportOption);
...
void MainWindow::fillReport()
{
    ...
    //fill information
    m_datas[3][3] = m_reportOption.client;
    m_datas[4][3] = m_reportOption.project;
    m_datas[3][11] = m_reportOption.report_number;
    m_datas[4][11] = QDateTime::currentDateTime().date().toString("dd.MM.yyyy");
    ...
    m_datas[45][4] = m_reportOption.days_per_year;
    m_datas[46][4] = m_reportOption.cost_per_kWh;
    ...
    m_datas[78][4] = m_reportOption.days_per_year;
    m_datas[79][4] = m_reportOption.cost_per_kWh;
   ...
   //insert curve
    ...
    clipboard->setPixmap(map.scaled(1205,827,Qt::KeepAspectRatio,Qt::SmoothTransformation));
