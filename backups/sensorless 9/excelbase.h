...
public:
    ...
    QVariant readAll(QString cellRange);
    void readAll(QList<QList<QVariant> > &cells, QString cellRange);
    ...
    void setCellBkColor(int row, int col, int colorIndex);
    void hideOneRow(int row);
    void deleteOneRow(int row);
