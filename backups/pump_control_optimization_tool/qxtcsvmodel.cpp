...
void QxtCsvModel::setSource(const QString filename, bool withHeader, QChar separator, QStringConverter::Encoding *codec)
{
    QFile src(filename);
    setSource(&src, withHeader, separator, codec);
}

void QxtCsvModel::setSource(QIODevice *file, bool withHeader, QChar separator, QStringConverter::Encoding *codec)
{
 ...
 */ 
void QxtCsvModel::toCSV(QIODevice* dest, bool withHeader, QChar separator, QStringConverter::Encoding *codec) const
{
    ...
    if(codec) stream.setEncoding(*codec);
...
void QxtCsvModel::toCSV(const QString filename, bool withHeader, QChar separator, QStringConverter::Encoding *codec) const
{
    QFile dest(filename);
