...
public:
    ...
    double                  CalcuSystemFlow(double *balanced_pump_head,double *valve_dps, double *valve_flows);
    void                    Reset();
...
private:
    ...
    double              GetValveDpFromFlow(double flow, double *valve_dps, double *valve_flows);
