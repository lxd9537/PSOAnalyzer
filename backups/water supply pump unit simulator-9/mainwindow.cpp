...
void MainWindow::on_cycle_1000ms()
{
    ...
    if(complete_flag)
    {
        ...
        str = QString::number(m_pump_unit.ReadOneValveRwData(0).pressure_drop,'f',2);
        str += " bar";
        ui->Edit_tap_press_1->setText(str);

        str = QString::number(m_pump_unit.ReadOneValveRwData(1).pressure_drop,'f',2);
        str += " bar";
        ui->Edit_tap_press_2->setText(str);

        str = QString::number(m_pump_unit.ReadOneValveRwData(2).pressure_drop,'f',2);
        str += " bar";
        ui->Edit_tap_press_3->setText(str);
