...
Q_SIGNALS:
    ...
    void insertProperty(QString property_name);
    void deleteProperty(QString property_name);
...
public slots:
    void onInsert() {
        emit insertProperty(this->currentItem()->property()->propertyName());
    };
    void onDelete() {
        emit deleteProperty(this->currentItem()->property()->propertyName());
    }
