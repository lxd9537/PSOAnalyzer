...
protected:
    ...
    void onInsert(void) { emit insertItem(); };
    void onDelete(void) { emit deleteItem(); };
...
void QtPropertyEditorView::contextMenuEvent(QContextMenuEvent *event) {
    ...
    m_editorPrivate(0)
{
    ...
    m_menu->addAction("插入", this, &QtPropertyEditorView::onInsert);
    m_menu->addAction("删除", this, &QtPropertyEditorView::onDelete);
    ...
    : QtAbstractPropertyBrowser(parent), d_ptr(new QtTreePropertyBrowserPrivate)
{
    ...
    connect(d_ptr->treeWidget(), &QtPropertyEditorView::insertItem, this, &QtTreePropertyBrowser::onInsert);
    connect(d_ptr->treeWidget(), &QtPropertyEditorView::deleteItem, this, &QtTreePropertyBrowser::onDelete);
}
