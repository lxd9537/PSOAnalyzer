...
void CModbusServerThread::onModbusStateChanged(QModbusDevice::State state) {
    ...
    case QModbusDevice::ClosingState:
        ...
        emit eventReport(m_id, EVENT_CODE_MODBUS_SERVER_CLOSING);
        break;
    case QModbusDevice::ConnectingState:
        m_current_error_text = EVENT_TEXT_MODBUS_SERVER_CONNECTING;
        emit eventReport(m_id, EVENT_CODE_MODBUS_SERVER_CONNECTING);
        break;
    case QModbusDevice::ConnectedState:
        m_current_error_text = EVENT_TEXT_MODBUS_SERVER_CONNECTED;
        emit eventReport(m_id, EVENT_CODE_MODBUS_SERVER_CONNECTED);
        break;
    case QModbusDevice::UnconnectedState:
        m_current_error_text = EVENT_TEXT_MODBUS_SERVER_UNCONNECTED;
        emit eventReport(m_id, EVENT_CODE_MODBUS_SERVER_UNCONNECTED);
        break;
    }
}
...
void CModbusServerThread::onModbusErrorOccurs() {
    ...
    emit eventReport(m_id, ERROR_CODE_MODBUS_SERVER_GEN_ERROR);
}
